...
func NewLlamadaExpresion(Id string, Parametro *arrayList.List, Row int, Column int) LlamadaExpresion {
	instr := LlamadaExpresion{Id, Parametro, Row, Column}
	return instr
}

func (p LlamadaExpresion) Compilar(env *interfaces.Environment, tree *interfaces.Arbol, gen *interfaces.Generator) interfaces.Value {
